...
def generate_dot_by_radare2(bin_file_path: str, sample_name: str, timeout_sec: int = 1) -> str:
    """
    ...
    # args = ['timeout', str(timeout_sec), 'r2', '-d', '-c', 'aa', '-c', f'\"agCd>{saved_file_path}\"', '-q', bin_file_path]
    # print(args)
    # try:        
